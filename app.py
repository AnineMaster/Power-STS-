...
# =====================================================================
# DYNAMIC PATH RESOLUTION (Solving Import and Sandbox Errors)
# =====================================================================
...
def load_models():
    ...
    if omnivoice_model is None:
        ...
        try:
            # Dynamic Config Finder (Finding config.yaml inside OmniVoice folder recursively)
            ...
            if config_files:
                ...
                # Config path ke sath model load karna
                omnivoice_model = OmniVoice_Class(config=config_path)
            else:
